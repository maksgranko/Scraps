...
namespace Scraps.Database
{
    ...
    {
        /// <summary>Только создать базу данных, без таблиц.</summary>
        None,
        /// <summary>Минимум: только таблица Users (Role как строка).</summary>
        Simple,
        /// <summary>Стандарт: Users + Roles (Role как внешний ключ).</summary>
        Standard,
        /// <summary>Полный: Users + Roles + RolePermissions (система прав).</summary>
        Full
    }
    ...
    public class DatabaseGenerationOptions
    {
        ...
        /// <summary>Создать опции с значениями по умолчанию из ScrapsConfig.</summary>
        public static DatabaseGenerationOptions Default() => new DatabaseGenerationOptions();

        /// <summary>Создать опции для указанной базы данных.</summary>
        ...
        /// <summary>Только база данных, без таблиц.</summary>
        ...
        /// <summary>Простой режим: только Users (Role как строка).</summary>
        ...
        /// <summary>Стандартный режим: Users + Roles.</summary>
        ...
        /// <summary>Полный режим: Users + Roles + RolePermissions.</summary>
