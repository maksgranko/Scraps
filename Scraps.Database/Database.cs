...
namespace Scraps.Database
{
    ...
    public static class Current
    {
        ...
        /// <summary>
        /// Сформировать строку подключения/путь для текущего провайдера.
        /// Для MSSQL: имя БД или готовая connection string.
        /// Для LocalFiles: путь к папке данных.
        /// </summary>
        public static string ConnectionStringBuilder(string value = null)
            => Active.Connection.ConnectionStringBuilder(value);
