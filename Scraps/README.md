...
Scraps — небольшая библиотека помощник, вынесенная из DPGTProject. Тут собраны повторно используемые методы для работы с БД, правами, переводами, авторизацией/сессией, импортом и экспортом.
