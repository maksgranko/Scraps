...
namespace Scraps.Database.LocalFiles
{
    ...
    public class LocalDatabaseRolePermissions : IDatabaseRolePermissions
    {
        ...
        /// <summary>Получить все записи прав.</summary>
        ...
        /// <summary>Получить права по имени роли.</summary>
        ...
        /// <summary>Получить права по ID роли.</summary>
        ...
        /// <summary>Установить права для таблицы по имени роли. Заменяет существующую запись.</summary>
        ...
        /// <summary>Установить права для таблицы по ID роли. Заменяет существующую запись.</summary>
        ...
        /// <summary>Удалить права для таблицы по имени роли.</summary>
        ...
        /// <summary>Удалить права для таблицы по ID роли.</summary>
        ...
        /// <summary>Удалить все права для роли по имени.</summary>
        ...
        /// <summary>Удалить все права для роли по ID.</summary>
